  ...
  <FadeIn inKey="home">
    ...
    <section className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
        <Card title="PriceFinder" subtitle="Wohlfühl-, Wachstums- & Authority-Preis" className="w-full max-w-sm text-center">
          <p className="text-sm text-neutral-400">Klarer, sauberer Pricing-Flow.</p>
          <div className="mt-6">
            <Button onClick={() => setTool("pricefinder")}>Öffnen</Button>
          </div>
        </Card>
        <Card title="MessageMatcher" subtitle="Messaging-Map aus Bio/Website" className="w-full max-w-sm text-center">
          <p className="text-sm text-neutral-400">Positionierung ohne Ratespiel.</p>
          <div className="mt-6">
            <Button onClick={() => setTool("messagematcher")}>Öffnen</Button>
          </div>
        </Card>
        <Card title="ContentFlow" subtitle="Hooks, Stories, Captions" className="w-full max-w-sm text-center">
