// src/App.jsx — dark+gold, zentriert, Dashboard, build-fähig (ohne Template-Strings in Klassen)
...
function Button({ children, onClick, variant = "solid", className = "", type = "button", disabled = false }) {
  // Farben per CSS-Variablen, damit Tailwind die Klassen statisch parsen kann
